"""Authentication helpers for GraphConnect."""
...
CONFIG_DIR = Path.home() / ".graphconnect"
...
def _scopes_block() -> str:
    """Return a PowerShell snippet that binds $requiredScopes to the CLI scope list."""
...
def _device_code_callback(verification_uri: str, user_code: str, expires_on: object) -> None:
    """Print the device-code prompt for the user."""
    del expires_on
