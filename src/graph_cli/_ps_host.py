...
_READY_ERROR = (
    ...
    "Run graph auth login or Connect-MgGraph -UseDeviceCode."
)
...
class GraphPowerShellHost:
    ...
    def invoke(
        ...
        *,
        ...
        with self._lock:
            ...
            raise RuntimeError("PowerShell host retry logic exhausted.")
    ...
    def _spawn_process(self) -> subprocess.Popen[str]:
        ...
        from graph_cli.auth import _build_powershell_invocation
